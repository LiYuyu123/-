      ...
      return new Promise((resolve, reject) => {
        getStation({ data: { stid: 58665 } })
          .then((res) => {
            ...
            this.inforData[0].number = parseFloat(res.data.data.pr) + "mm";
            this.inforData[1].number = res.data.data.rh + "%";
            this.inforData[2].number = parseFloat(res.data.data.ws) + "m/s";
